...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TMP_DIR="/tmp/proftpd"
RUN_DIR="/run/proftpd"       # set scripts pid dir
...
SERVICE_USER="proftpd"  # execute command as another user
SERVICE_GROUP="proftpd" # Set the service group
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
EXEC_CMD_ARGS='--nodaemon -c /etc/proftpd/proftpd.conf' # command arguments
...
[ -f "$CONF_DIR/env/proftpd.script.sh" ] && . "$CONF_DIR/env/proftpd.script.sh" # Generated by my dockermgr script
[ -f "$CONF_DIR/env/proftpd.sh" ] && . "$CONF_DIR/env/proftpd.sh"               # Overwrite the variabes
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
