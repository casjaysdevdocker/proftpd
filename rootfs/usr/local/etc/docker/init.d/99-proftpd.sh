...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202406261030-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.pro
# @@License          :  LICENSE.md
# @@ReadME           :  99-proftpd.sh --help
# @@Copyright        :  Copyright: (c) 2024 Jason Hempstead, Casjays Developments
# @@Created          :  Wednesday, Jun 26, 2024 10:30 EDT
# @@File             :  99-proftpd.sh
# @@Description      :
...
# set data directory
DATA_DIR="/data/proftpd"
# set config directory
CONF_DIR="/config/proftpd"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# root user name
root_user_name="${PROFTPD_ROOT_USER_NAME:-}"
# root user password
root_user_pass="${PROFTPD_ROOT_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Normal user info [password/random]
# normal user name
user_name="${PROFTPD_USER_NAME:-}"
# normal user password
user_pass="${PROFTPD_USER_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
SERVICE_USER="proftpd"
# Set the service group
SERVICE_GROUP="proftpd"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# command to execute
EXEC_CMD_BIN='proftpd'
# command arguments
EXEC_CMD_ARGS='--nodaemon -c /etc/proftpd/proftpd.conf'
...
[ -f "$CONF_DIR/env/proftpd.script.sh" ] && . "$CONF_DIR/env/proftpd.script.sh"
# Overwrite the variabes
[ -f "$CONF_DIR/env/proftpd.sh" ] && . "$CONF_DIR/env/proftpd.sh"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# root/admin user info [password/random]
#ENV_ROOT_USER_NAME="${ENV_ROOT_USER_NAME:-$PROFTPD_ROOT_USER_NAME}"   # root user name
#ENV_ROOT_USER_PASS="${ENV_ROOT_USER_NAME:-$PROFTPD_ROOT_PASS_WORD}"   # root user password
#root_user_name="${ENV_ROOT_USER_NAME:-$root_user_name}"                              #
#root_user_pass="${ENV_ROOT_USER_PASS:-$root_user_pass}"                              #
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#Normal user info [password/random]
#ENV_USER_NAME="${ENV_USER_NAME:-$PROFTPD_USER_NAME}"                  #
#ENV_USER_PASS="${ENV_USER_PASS:-$PROFTPD_USER_PASS_WORD}"             #
